  ...
  return (
    <div ref={containerRef} className="min-h-screen bg-[#f5f5f7] text-black font-sans pb-32">
      ...
      <div className="relative h-[80vh] w-full overflow-hidden">
        ...
        <div className="absolute inset-0 flex flex-col justify-end p-8 lg:p-24 pb-12 z-10 text-black">
          <motion.div
            ...
            className="max-w-4xl"
          >
            <h4 className="text-black/60 text-lg lg:text-xl font-bold tracking-widest uppercase mb-4">
              {person.relation}
            </h4>
      ...
      <div className="max-w-[1200px] mx-auto px-6 lg:px-12 mt-20 flex flex-col gap-32">
        ...
        >
          <div className="flex items-center gap-3 mb-8">
            ...
            <h2 className="text-4xl font-bold tracking-tight">Favorite Moments</h2>
          </div>
          <div className="flex gap-6 overflow-x-auto pb-8 snap-x snap-mandatory [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
            {person.favoriteMoments.map((moment, idx) => (
              ...
              >
                <img src={moment.image} alt={moment.title} className="w-full h-full object-cover transition-transform duration-1000 group-hover:scale-105" />
        ...
        <motion.section
          ...
          viewport={{ once: true, margin: "-100px" }}
        >
          <h2 className="text-4xl font-bold tracking-tight mb-12">Our Story</h2>
          <div className="relative border-l-2 border-black/10 ml-4 lg:ml-8 space-y-16 pb-8">
            {person.timeline.map((item, idx) => (
              <div key={idx} className="relative pl-10 lg:pl-16">
                ...
                <motion.div 
                  whileHover={{ scale: 1.02 }}
                  className="relative h-[300px] lg:h-[400px] max-w-3xl rounded-[32px] overflow-hidden shadow-[0_20px_50px_-12px_rgba(0,0,0,0.1)] border border-white"
                >
        ...
        <motion.section
          ...
          viewport={{ once: true, margin: "-100px" }}
        >
          <h2 className="text-4xl font-bold tracking-tight mb-8">All Shared Memories</h2>
          <div className="columns-2 md:columns-3 gap-4 space-y-4">
            {person.sharedMemories.map((imgUrl, idx) => (
              ...
              >
                <img src={imgUrl} alt={`Shared Memory ${idx}`} className="w-full h-auto object-cover" />
              </motion.div>
            ))}
          </div>
        </motion.section>
